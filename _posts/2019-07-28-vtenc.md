...
![VTEnc binary table](/assets/images/vtenc-table.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![VTEnc clusters](/assets/images/vtenc-clusters.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![VTEnc clusters tree](/assets/images/vtenc-clusters-tree.png)
{: refdef}
...
{:refdef: style="text-align: center;"}
![VTEnc binary tree](/assets/images/vtenc-binary-tree.png)
{: refdef}
